...
from utilities import print_2d_isolines, print_2d, print_3d_boundaries_on_cube
...
theta_b = project(Expression('0.5 - x[1] / 2 + x[2] / 2', degree=3), simple_space)
theta_b_4 = project(Expression('pow(t, 4)', degree=3, t=theta_b,), simple_space)
gamma = Expression("0.3 * cos(x[1]*3.14/2) + 0.1", degree=3)
...
print_3d_boundaries_on_cube(theta_ans, name='theta_bw', folder='scratch')
print_3d_boundaries_on_cube(phi_ans, name='phi_bw', folder='scratch')
