\section{Постановка обратной задачи}
    ...
    Уравнения \eqref{initial} дополняются граничными условиями на $\Gamma := \partial \Omega =\bar{\Gamma}_0 \cup \bar{\Gamma}_1 \cup \bar{\Gamma}_2$, где $\Gamma_0, \Gamma_1, \Gamma_2$ не имеют пересечений.
