\section{Постановка обратной задачи}
    ...
    Уравнения \eqref{initial} дополняются граничными условиями на $\Gamma := \partial \Omega =\bar{\Gamma_0} \cup \bar{\Gamma_1} \cup \bar{\Gamma_2}$, где части границы $\Gamma_0, \Gamma_1, \Gamma_2$ не имеют пересечений.
