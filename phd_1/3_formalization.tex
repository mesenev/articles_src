...
Задача нахождения квазирешения состоит в минимизации функционала $J(\theta)$, определенном на компоненте $\theta$ решения системы \eqref{weak_operational}. Таким образом
    \begin{equation}
