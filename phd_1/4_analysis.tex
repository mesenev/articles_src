...
\label{SolvabilityLemma}
    ...
    Если условие (i) выполняется, то для каждого $ u \in U_{ad} $ существует единственное слабое решение $\{\theta, \varphi \}$ для задачи \eqref{initial},\eqref{initial_boundary}, также верны следующие оценки:
    \begin{equation}
        \label{lemma_1}
...
% \begin{lem}[Лемма 2 в \cite{covt_last}]
