...
%\Large
    ...
    На рисунке~\ref{fig:img_test_1} представлен модуль относительного отклонения $\partial_n\theta_\lambda$ от $q_b$
    ...
    \begin{figure}[H]
        ...
        { \label{fig:img_test_1} \includegraphics[width=.49\linewidth]{img/exp1/theta_n_diff_auto.png}
        }
...
%  Убрать график Боткина
    ...
    Значение функционала качества, определяющего
    норму разности $\|\theta_\lambda -\theta_b\|^2_\Gamma$, равно $~0.000255$ и стабилизируется после 10
    итераций.
