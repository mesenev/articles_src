...
%    Исходные коды расчётов для настоящей статьи представлены по адресу \url{https://github.com/mesenev/articles_src}
    ...
    \begin{figure}[H]
        ...
        {
            \label{fig3:exp1}
            \includegraphics[width=.49\linewidth]{img/exp2/init_theta}
        }
        ...
        \caption{Компонента температуры, соотвествующая управлению $u_0$ и $u_{end}$}
    ...
    \begin{figure}[H]
        ...
        {
            \label{fig4:exp1}
            \includegraphics[width=.49\linewidth]{img/exp2/init_phi}
        }
        ...
        \caption{Компонента излучения, соотвествующее управлению $u_0$ и $u_{end}$}
        \label{phi_dynamics}
    \end{figure}
