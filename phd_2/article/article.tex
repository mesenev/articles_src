...
%\Large
    ...
    \begin{figure}[H]
        ...
        { \label{fig:img_test_11} \includegraphics[width=.49\linewidth]{img/exp11/theta_n_diff_iso}
        }
    ...
    \begin{figure}[H]
        \centering
        \subfloat[$|q_n - \partial_n\theta_\lambda|$]
        { \label{fig:img_test_11_cube} \includegraphics[width=.49\linewidth]{img/exp11/theta_n_diff_cube}
        }
        \subfloat[Изменение функционала в зависимости от числа итераций]
        { \includegraphics[width=.49\linewidth]{img/exp11/quality} }
        \caption{Результаты первого эксперимента}
    ...
    \begin{figure}[H]
        \centering
        \subfloat[$|q_n - \partial_n\theta_\lambda|$]
        { \label{fig:img_test_12_iso} \includegraphics[width=.49\linewidth]{img/exp12/theta_n_diff_iso}
        }
        \subfloat[Изменение функционала в зависимости от числа итераций]
    ...
    \begin{figure}[H]
        \centering
        \subfloat[$|q_n - \partial_n\theta_\lambda|$]
        { \label{fig:img_test_12_cube} \includegraphics[width=.49\linewidth]{img/exp12/theta_n_diff_cube}
        }
        \subfloat[Изменение функционала в зависимости от числа итераций]
        { \includegraphics[width=.49\linewidth]{img/exp12/quality} }
        \caption{Результаты первого эксперимента}
